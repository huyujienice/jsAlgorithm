...
//     while (n > 0) {
//       let f = Math.floor((n - 1) / 2);
//       if (this.data[f] <= this.data[n]) {
//         const mid = this.data[f];
...
//         const max = l > r ? 2 * n + 1 : 2 * n + 2;
//         if (this.data[max] > this.data[n]) {
//           const mid = this.data[max];
//           this.data[max] = this.data[n];
//           this.data[n] = mid;
//           m = max;
//         }
//       } else {
//         if (this.data[2 * n + 1] > this.data[n]) {
//           const mid = this.data[2 * n + 1];
//           this.data[2 * n + 1] = this.data[n];
//           this.data[n] = mid;
//           m = 2 * n + 1;
//         }
//       }
...
//       let f = Math.floor((n - 1) / 2);
//       if (this.data[f] >= this.data[n]) {
//         const mid = this.data[n];
//         this.data[n] = this.data[f];
//         this.data[f] = mid;
//         n = f;
//       } else {
//         break;
...
//       if (2 * n + 2 < this.data.length) {
//         let l = this.data[2 * n + 1];
//         let r = this.data[2 * n + 2];
//         let j = l < r ? 2 * n + 1 : 2 * n + 2;
//         if (this.data[j] < this.data[n]) {
//           const mid = this.data[j];
