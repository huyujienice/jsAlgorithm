...
堆适合维护：集合最值  
大顶堆可用于维护前n小元素，因为大顶堆弹出的是集合内最大的
小顶堆可用于维护前n大元素，因为小顶堆弹出的是集合内最小的
...
动态规划被认为是与递归相反的技术。因为递归是从顶部开始将问题分解，通过解决掉所有分解出小问题的方式，来解决整个问题。动态规划解决方案是从底部开始解决问题，将所有小问题解决掉，然后合并成一个整体的解决方案，从而解决掉整个大问题
